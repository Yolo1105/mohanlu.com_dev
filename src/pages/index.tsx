  ...
  return (
    <>
      ...
      <div className="flex h-screen overflow-hidden pt-16">
        <div
          className="flex-grow grid grid-cols-3 gap-2 p-2"
          style={{ marginLeft: '50px' }}
        >
          <div className="col-span-2 border-2 overflow-hidden flex flex-col">
          ...
          <div className="flex flex-col gap-2">
            <div className="border-2 p-4 flex-grow overflow-y-auto">
